{
  ...
  "metadata": {
    "colab": {
      ...
      "authorship_tag": "ABX9TyMjNAB0I9awHE69Aj82nqaL",
  ...
  "cells": [
    {
      ...
      "source": [
        "<a href=\"https://colab.research.google.com/github/jsp289/CS5901_Assignment2/blob/main/CS5901_assignment2_stage1_data_cleaning_py.py\" target=\"_parent\"><img src=\"https://colab.research.google.com/assets/colab-badge.svg\" alt=\"Open In Colab\"/></a>"
      ]
    },
    {
      "cell_type": "markdown",
    ...
    },
    {
      ...
      "metadata": {
        ...
        "collapsed": true,
        "id": "EGdyxOVkGTKm",
        "outputId": "5fd74d91-7756-45d4-814b-71f8f6e19ae9"
      },
      "outputs": [
        {
          "output_type": "stream",
        ...
        },
        {
          ...
          "data": {
            ...
            "text/html": [
              "\n",
              "  <div id=\"df-1aca4b3d-d149-4027-9256-2200643b5f12\" class=\"colab-df-container\">\n",
              "    <div>\n",
              "<style scoped>\n",
              ...
              "    <button class=\"colab-df-convert\" onclick=\"convertToInteractive('df-1aca4b3d-d149-4027-9256-2200643b5f12')\"\n",
              ...
              "    <script>\n",
              "      const buttonEl =\n",
              "        document.querySelector('#df-1aca4b3d-d149-4027-9256-2200643b5f12 button.colab-df-convert');\n",
              "      buttonEl.style.display =\n",
              "        google.colab.kernel.accessAllowed ? 'block' : 'none';\n",
              "\n",
              "      async function convertToInteractive(key) {\n",
              "        const element = document.querySelector('#df-1aca4b3d-d149-4027-9256-2200643b5f12');\n",
              "        const dataTable =\n",
              ...
              "\n",
              "\n",
              "    <div id=\"df-5d21509b-d617-4632-90bc-ee4078bafae5\">\n",
              "      <button class=\"colab-df-quickchart\" onclick=\"quickchart('df-5d21509b-d617-4632-90bc-ee4078bafae5')\"\n",
              ...
              "            document.querySelector('#df-5d21509b-d617-4632-90bc-ee4078bafae5 button');\n",
            ...
            "application/vnd.google.colaboratory.intrinsic+json": {
              "type": "dataframe",
              "variable_name": "df",
              "summary": "{\n  \"name\": \"df\",\n  \"rows\": 482,\n  \"fields\": [\n    {\n      \"column\": \"Level\",\n      \"properties\": {\n        \"dtype\": \"number\",\n        \"std\": 61,\n        \"min\": 5,\n        \"max\": 400,\n        \"num_unique_values\": 14,\n        \"samples\": [\n          25,\n          400,\n          5\n        ],\n        \"semantic_type\": \"\",\n        \"description\": \"\"\n      }\n    },\n    {\n      \"column\": \"T4\",\n      \"properties\": {\n        \"dtype\": \"number\",\n        \"std\": 19.81902038165894,\n        \"min\": -44.4,\n        \"max\": 235.2,\n        \"num_unique_values\": 383,\n        \"samples\": [\n          28.07777778,\n          5.113043478,\n          8.484848485\n        ],\n        \"semantic_type\": \"\",\n        \"description\": \"\"\n      }\n    },\n    {\n      \"column\": \"T3\",\n      \"properties\": {\n        \"dtype\": \"number\",\n        \"std\": 16.300897785019764,\n        \"min\": -38.4,\n        \"max\": 148.4,\n        \"num_unique_values\": 315,\n        \"samples\": [\n          -0.486956522,\n          0.6,\n          6.076595745\n        ],\n        \"semantic_type\": \"\",\n        \"description\": \"\"\n      }\n    },\n    {\n      \"column\": \"T3adjusted\",\n      \"properties\": {\n        \"dtype\": \"number\",\n        \"std\": 1.2780723852201836,\n        \"min\": -3.541014105,\n        \"max\": 6.172755936,\n        \"num_unique_values\": 384,\n        \"samples\": [\n          1.096309134,\n          1.654339307,\n          3.066072262\n        ],\n        \"semantic_type\": \"\",\n        \"description\": \"\"\n      }\n    },\n    {\n      \"column\": \"T4adjusted\",\n      \"properties\": {\n        \"dtype\": \"number\",\n        \"std\": 1.2424206309702421,\n        \"min\": -3.373730661,\n        \"max\": 5.294333567,\n        \"num_unique_values\": 315,\n        \"samples\": [\n          -0.786737882,\n          0.843432665,\n          1.824820348\n        ],\n        \"semantic_type\": \"\",\n        \"description\": \"\"\n      }\n    }\n  ]\n}"
            }
          },
          "metadata": {},
          "execution_count": 1
    ...
    },
    {
      ...
      "metadata": {
        ...
        "outputId": "5d3ec307-2f5d-4f67-aafd-609dc506eec7"
      },
      "execution_count": 2,
      "outputs": [
        {
          ...
          "data": {
            ...
            "text/html": [
              "\n",
              "  <div id=\"df-66ac8f0a-c1c7-422c-ad96-cd1ec19d9a7a\" class=\"colab-df-container\">\n",
              "    <div>\n",
              "<style scoped>\n",
              "    .dataframe tbody tr th:only-of-type {\n",
              "        vertical-align: middle;\n",
              ...
              "\n",
              "  <div class=\"colab-df-container\">\n",
              "    <button class=\"colab-df-convert\" onclick=\"convertToInteractive('df-66ac8f0a-c1c7-422c-ad96-cd1ec19d9a7a')\"\n",
              "            title=\"Convert this dataframe to an interactive table.\"\n",
              "            style=\"display:none;\">\n",
              "\n",
              "  <svg xmlns=\"http://www.w3.org/2000/svg\" height=\"24px\" viewBox=\"0 -960 960 960\">\n",
              ...
              "    <script>\n",
              "      const buttonEl =\n",
              "        document.querySelector('#df-66ac8f0a-c1c7-422c-ad96-cd1ec19d9a7a button.colab-df-convert');\n",
              "      buttonEl.style.display =\n",
              "        google.colab.kernel.accessAllowed ? 'block' : 'none';\n",
              "\n",
              "      async function convertToInteractive(key) {\n",
              "        const element = document.querySelector('#df-66ac8f0a-c1c7-422c-ad96-cd1ec19d9a7a');\n",
              "        const dataTable =\n",
              "          await google.colab.kernel.invokeFunction('convertToInteractive',\n",
              "                                                    [key], {});\n",
              "        if (!dataTable) return;\n",
              ...
              "\n",
              "\n",
              "    <div id=\"df-a1821bc1-2b11-45dc-bc54-35892c05b102\">\n",
              "      <button class=\"colab-df-quickchart\" onclick=\"quickchart('df-a1821bc1-2b11-45dc-bc54-35892c05b102')\"\n",
              "                title=\"Suggest charts\"\n",
              "                style=\"display:none;\">\n",
              "\n",
              "<svg xmlns=\"http://www.w3.org/2000/svg\" height=\"24px\"viewBox=\"0 0 24 24\"\n",
              ...
              "        (() => {\n",
              "          let quickchartButtonEl =\n",
              "            document.querySelector('#df-a1821bc1-2b11-45dc-bc54-35892c05b102 button');\n",
              "          quickchartButtonEl.style.display =\n",
              "            google.colab.kernel.accessAllowed ? 'block' : 'none';\n",
              "        })();\n",
              "      </script>\n",
            ...
            "application/vnd.google.colaboratory.intrinsic+json": {
              "type": "dataframe",
              "summary": "{\n  \"name\": \"#invalid_rows\",\n  \"rows\": 5,\n  \"fields\": [\n    {\n      \"column\": \"Level\",\n      \"properties\": {\n        \"dtype\": \"number\",\n        \"std\": 10,\n        \"min\": 5,\n        \"max\": 30,\n        \"num_unique_values\": 3,\n        \"samples\": [\n          5,\n          20,\n          30\n        ],\n        \"semantic_type\": \"\",\n        \"description\": \"\"\n      }\n    },\n    {\n      \"column\": \"T4\",\n      \"properties\": {\n        \"dtype\": \"number\",\n        \"std\": 2.655560204551951,\n        \"min\": 2.3,\n        \"max\": 8.7,\n        \"num_unique_values\": 5,\n        \"samples\": [\n          8.7,\n          5.4,\n          7.9\n        ],\n        \"semantic_type\": \"\",\n        \"description\": \"\"\n      }\n    },\n    {\n      \"column\": \"T3\",\n      \"properties\": {\n        \"dtype\": \"number\",\n        \"std\": 1.7289206652321172,\n        \"min\": 0.4,\n        \"max\": 4.6,\n        \"num_unique_values\": 4,\n        \"samples\": [\n          4.6,\n          2.6,\n          2.1\n        ],\n        \"semantic_type\": \"\",\n        \"description\": \"\"\n      }\n    },\n    {\n      \"column\": \"T3adjusted\",\n      \"properties\": {\n        \"dtype\": \"number\",\n        \"std\": 0.3062060195721481,\n        \"min\": 1.320006122,\n        \"max\": 2.056710116,\n        \"num_unique_values\": 5,\n        \"samples\": [\n          2.056710116,\n          1.754410643,\n          1.991631701\n        ],\n        \"semantic_type\": \"\",\n        \"description\": \"\"\n      }\n    },\n    {\n      \"column\": \"T4adjusted\",\n      \"properties\": {\n        \"dtype\": \"number\",\n        \"std\": 0.3872242732078908,\n        \"min\": 0.7368063,\n        \"max\": 1.663103499,\n        \"num_unique_values\": 4,\n        \"samples\": [\n          1.663103499,\n          1.375068867,\n          1.280579165\n        ],\n        \"semantic_type\": \"\",\n        \"description\": \"\"\n      }\n    }\n  ]\n}"
            }
          },
          "metadata": {},
          "execution_count": 2
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "H9HzVXkZaev8",
        "outputId": "70a14161-3c3c-4f5e-d5ab-c6939a8bad77"
      },
      "execution_count": 3,
      "outputs": [
        {
          ...
          "data": {
            ...
            "text/html": [
              "\n",
              "  <div id=\"df-84617113-1438-4323-95bf-99718e907efc\" class=\"colab-df-container\">\n",
              "    <div>\n",
              "<style scoped>\n",
              "    .dataframe tbody tr th:only-of-type {\n",
              "        vertical-align: middle;\n",
              ...
              "\n",
              "  <div class=\"colab-df-container\">\n",
              "    <button class=\"colab-df-convert\" onclick=\"convertToInteractive('df-84617113-1438-4323-95bf-99718e907efc')\"\n",
              "            title=\"Convert this dataframe to an interactive table.\"\n",
              "            style=\"display:none;\">\n",
              "\n",
              "  <svg xmlns=\"http://www.w3.org/2000/svg\" height=\"24px\" viewBox=\"0 -960 960 960\">\n",
              ...
              "    <script>\n",
              "      const buttonEl =\n",
              "        document.querySelector('#df-84617113-1438-4323-95bf-99718e907efc button.colab-df-convert');\n",
              "      buttonEl.style.display =\n",
              "        google.colab.kernel.accessAllowed ? 'block' : 'none';\n",
              "\n",
              "      async function convertToInteractive(key) {\n",
              "        const element = document.querySelector('#df-84617113-1438-4323-95bf-99718e907efc');\n",
              "        const dataTable =\n",
              "          await google.colab.kernel.invokeFunction('convertToInteractive',\n",
              "                                                    [key], {});\n",
              "        if (!dataTable) return;\n",
              ...
              "\n",
              "\n",
              "    <div id=\"df-7b8a9570-f8ab-4d78-9714-78cbbd17fca4\">\n",
              "      <button class=\"colab-df-quickchart\" onclick=\"quickchart('df-7b8a9570-f8ab-4d78-9714-78cbbd17fca4')\"\n",
              "                title=\"Suggest charts\"\n",
              "                style=\"display:none;\">\n",
              "\n",
              "<svg xmlns=\"http://www.w3.org/2000/svg\" height=\"24px\"viewBox=\"0 0 24 24\"\n",
              ...
              "        (() => {\n",
              "          let quickchartButtonEl =\n",
              "            document.querySelector('#df-7b8a9570-f8ab-4d78-9714-78cbbd17fca4 button');\n",
              "          quickchartButtonEl.style.display =\n",
              "            google.colab.kernel.accessAllowed ? 'block' : 'none';\n",
              "        })();\n",
              "      </script>\n",
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "LWyjzRUKIabI",
        "outputId": "55d87f19-1c78-48f2-9dee-2cdcc0b91ca4"
      },
      "execution_count": 4,
      "outputs": [
        {
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "L1K8idxnQmnT",
        "outputId": "ed2ff7fd-d3c3-4308-e1f5-3ea037b824a3"
      },
      "execution_count": 5,
      "outputs": [
        {
        ...
        },
        {
          ...
          "data": {
            ...
            "text/html": [
              "\n",
              "  <div id=\"df-ed0f5cc3-9b7a-4f2d-b4b2-a48c0fab6cac\" class=\"colab-df-container\">\n",
              "    <div>\n",
              "<style scoped>\n",
              "    .dataframe tbody tr th:only-of-type {\n",
              "        vertical-align: middle;\n",
              ...
              "\n",
              "  <div class=\"colab-df-container\">\n",
              "    <button class=\"colab-df-convert\" onclick=\"convertToInteractive('df-ed0f5cc3-9b7a-4f2d-b4b2-a48c0fab6cac')\"\n",
              "            title=\"Convert this dataframe to an interactive table.\"\n",
              "            style=\"display:none;\">\n",
              "\n",
              "  <svg xmlns=\"http://www.w3.org/2000/svg\" height=\"24px\" viewBox=\"0 -960 960 960\">\n",
              ...
              "    <script>\n",
              "      const buttonEl =\n",
              "        document.querySelector('#df-ed0f5cc3-9b7a-4f2d-b4b2-a48c0fab6cac button.colab-df-convert');\n",
              "      buttonEl.style.display =\n",
              "        google.colab.kernel.accessAllowed ? 'block' : 'none';\n",
              "\n",
              "      async function convertToInteractive(key) {\n",
              "        const element = document.querySelector('#df-ed0f5cc3-9b7a-4f2d-b4b2-a48c0fab6cac');\n",
              "        const dataTable =\n",
              "          await google.colab.kernel.invokeFunction('convertToInteractive',\n",
              "                                                    [key], {});\n",
              "        if (!dataTable) return;\n",
              ...
              "\n",
              "\n",
              "    <div id=\"df-fbba83ee-cf0f-4eeb-82ff-2fdeed16036a\">\n",
              "      <button class=\"colab-df-quickchart\" onclick=\"quickchart('df-fbba83ee-cf0f-4eeb-82ff-2fdeed16036a')\"\n",
              "                title=\"Suggest charts\"\n",
              "                style=\"display:none;\">\n",
              "\n",
              "<svg xmlns=\"http://www.w3.org/2000/svg\" height=\"24px\"viewBox=\"0 0 24 24\"\n",
              ...
              "        (() => {\n",
              "          let quickchartButtonEl =\n",
              "            document.querySelector('#df-fbba83ee-cf0f-4eeb-82ff-2fdeed16036a button');\n",
              "          quickchartButtonEl.style.display =\n",
              "            google.colab.kernel.accessAllowed ? 'block' : 'none';\n",
              "        })();\n",
              "      </script>\n",
